...
public class ClientDownloader2 {
	int totalParts; 
	String fileName;
	int id;
	public ClientDownloader2 (String fileName, int totalParts) {
	...
	public static void main(String[] args) {
		...
		ClientDownloader2 cd;
		
		cd = new ClientDownloader2("u3059_OriginalVideo_480", 500);
		cd.run();

		cd = new ClientDownloader2("u3059_OriginalVideo_240", 500);
		cd.run();
